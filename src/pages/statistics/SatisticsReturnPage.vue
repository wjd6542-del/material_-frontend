  ...
  <div class="p-4 lg:p-6 bg-[#f8fafc] min-h-screen space-y-4 lg:space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
      <div class="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm hover:shadow-md transition-all group">
        <p class="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-2">총 반품 수량</p>
      ...
      <div class="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm hover:shadow-md transition-all group">
        <p class="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-2">반품 건수</p>
        <div class="flex items-center justify-between">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col h-full">
          <div class="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-white">
            <div class="flex items-center gap-2">
              ...
              <span class="font-bold text-slate-800 text-base">반품 통계 상세</span>
            </div>
          </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col h-full">
          <div class="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-white">
            <div class="flex items-center gap-2">
              ...
              <span class="font-bold text-slate-800 text-base">반품 금액 변동 추이 (Spline)</span>
            </div>
          </div>
...
export default {
  ...
  mixins: [
    createStatisticsMixin({
      listEndpoint: "/api/stat/returnList",
      chartEndpoint: "/api/stat/return/daily/totalAmount",
      setEndpoint: "/api/stat/return/daily",
