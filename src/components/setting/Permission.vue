...
export default {
  ...
  mixins: [
    createAgGridMixin({
      listEndpoint: "/api/permission/list",
      saveEndpoint: "/api/permission/batchSave",
      deleteEndpoint: "/api/permission/batchDelete",
      newRowDefaults: () => ({ name: "", code: "", group: "", action: "" }),
    }),
  ],
  ...
  data() {
    return {
      columnDefs: [
        { headerName: "권한명", field: "name", filter: "agTextColumnFilter", flex: 0.5 },
        { headerName: "권한 코드", field: "code", filter: "agTextColumnFilter", flex: 0.5 },
        { headerName: "그룹", field: "group", filter: "agTextColumnFilter", flex: 0.5 },
        { headerName: "액션", field: "action", filter: "agTextColumnFilter", flex: 0.5 },
