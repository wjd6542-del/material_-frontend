...
export default {
  ...
  mixins: [
    createAgGridMixin({
      listEndpoint: "/api/settings/list",
      saveEndpoint: "/api/settings/batchSave",
      deleteEndpoint: "/api/settings/batchDelete",
      newRowDefaults: () => ({
        key: "",
        text: "",
        value: "",
  ...
  data() {
    return {
      columnDefs: [
        { headerName: "키", field: "key", filter: "agTextColumnFilter", flex: 0.5 },
        { headerName: "텍스트", field: "text", filter: "agTextColumnFilter", flex: 0.5 },
        { headerName: "값", field: "value", filter: "agTextColumnFilter", flex: 0.5 },
