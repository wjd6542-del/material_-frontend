...
export default {
  ...
  mixins: [
    createAgGridMixin({
      listEndpoint: "/api/category/list",
      saveEndpoint: "/api/category/batchSave",
      deleteEndpoint: "/api/category/batchDelete",
  ...
  data() {
    return {
      columnDefs: [
        { headerName: "카테고리명", field: "name", filter: "agTextColumnFilter", flex: 0.5 },
        { headerName: "카테고리 코드", field: "code", filter: "agTextColumnFilter", flex: 0.5 },
