...
export default {
  ...
  mixins: [
    createAgGridMixin({
      listEndpoint: "/api/warehouse/list",
      saveEndpoint: "/api/warehouse/batchSave",
      deleteEndpoint: "/api/warehouse/batchDelete",
      newRowDefaults: () => ({
        code: "",
        name: "",
        memo: "",
  ...
  data() {
    return {
      columnDefs: [
        ...
        { headerName: "창고명", field: "name", filter: "agTextColumnFilter", flex: 0.5 },
        { headerName: "메모", field: "memo", filter: "agTextColumnFilter", flex: 0.5 },
