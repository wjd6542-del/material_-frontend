  ...
  data() {
    return {
      columnDefs: [
        ...
        { headerName: "코드", field: "code", filter: "agTextColumnFilter", flex: 0.7 },
        { headerName: "메모", field: "memo", filter: "agTextColumnFilter", flex: 1 },
        { headerName: "정렬", field: "sort", filter: "agNumberColumnFilter", flex: 0.3 },
      ],
    };
  },
};
