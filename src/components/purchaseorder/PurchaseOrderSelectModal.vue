  ...
  <div class="flex flex-col gap-4" style="height: 75vh">
    ...
    <div class="flex-1 flex gap-3 overflow-hidden border rounded-xl bg-white">
      ...
      <section class="w-1/2 flex flex-col overflow-hidden border-r">
        ...
        <div class="p-2 border-b flex items-center gap-1.5">
          <div class="relative flex-1">
            ...
            <input
              ...
              class="w-full h-[30px] pl-7 pr-2 text-xs border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
          </div>
          <SearchSelect
